	...
	<footer>
		<Container className={style.container}>
			...
			<div className={style.social}>
				<h3 className={style.socialTitle}>Связаться с нами</h3>
				<p className={style.socialSubtitle}>Контакты и адреса магазинов</p>
				<ul className={style.socialList}>
					<li>
						<a className={style.socialLinkVK}>
					...
					<li>
						<a className={style.socialLinkFB}>
							<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<ul className={style.contacts}>
				<li><a href='mailto:Inspired@gmail.com'>Inspired@gmail.com</a></li>
				<li><a href='tel:89304902620'>8 930 490 26 20</a></li>
			</ul>
			...
			<div className={style.development}>
				<ul className={style.developmentList}>
					...
					<li>Developer:  Vladislav Skvortsov</li>
				</ul>
			</div>			
		</Container>
	</footer>
